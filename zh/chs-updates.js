...
var cnItems = {
    ...
    'Added 2 new crit tiers': '增加了两阶新的暴击阶级。',
    'Added new World story messages leading up to Z325, with conditional messages based on Spire progress': '增加了新的故事消息，至区域325，根据尖塔进度，消息内容会发生变化。',
    'Added 4 new Scruffy abilities': '污污新增了4个技能。',
    'Increased Scruffy\'s damage scaling starting at level 25': '污污从25级开始，攻击力加成的增长速度变快了。',
    'Added 3 new purple Mutators': '增加了3个新的紫色突变因子。',
    'Added 2 new blue Mutators': '增加了2个新的蓝色突变因子。',
    'Added new achievements for highest Zone, speedruns to the new Spire, Seeds, and a new Melting point speedrun': '增加了区域进度：宇宙2、宇宙2最速：闷闷尖塔和宇宙2最速：熔点的新成就。',
    'The bonus from Glass to Radon now caps at Z400. The bonus from 175-400 still applies above 400, but no longer increases per Zone.': '玻璃挑战对氡的加成增加了区域400的上限。超过区域400后，区域175至区域400的加成仍然有效，只是不再随着区域增加而增加。',
    'Added 3 new items': '增加了3个新物品。',
    'Rings now gain a third slot at level 30': '灵戒到达30级后可以获得第3个槽位了。',
    'Increased enemy level cap to 160': '将敌人等级上限提升至160。',
    'Enemies between 150 and 160 now have a complete immunity to one damage type per level': '150级至160级的敌人会对某种伤害类型完全免疫。',
    'Capped SA bonuses Radon and Stats to level 50, capped Scaffolding to level 18': '尖塔突击的氡加成和属性加成追加了等级上限50级，脚手架加成追加了等级上限18级。',
    'Defeating the enemy at level 160 sets Radon and Stats bonuses to level 52, Scaffolding to 20, and grants the option to Seal the Spire': '击败160级的敌人后，将把氡加成和属性加成设置为52级，脚手架加成设置为20级，并追加选项关闭尖塔突击。',
    'Bloodstained Gloves are now capped at +160% attack bar fill (equivalent to level 28)': '染血手套的攻击进度条填充效果追加效果上限160%(即28级)',
    'AutoStorage is now unlocked from the first U1 Void Map completed at Z20 or above, down from Z40': '自动存储的解锁区域从区域40变为区域20，现在只需要在不低于区域20的区域通过一张虚空地图即可解锁。',
    'Adjusted Heirloom drop breakpoints to line up better with the ends of repeatable Helium challenges': '调整了传家宝提升稀有度的区域，以更好匹配可重复挑战。',
    'UberHouse now drops from Z28 instead of Z29': '超级宅院从区域29掉落改为区域28掉落。',
    'Completing a U1 Z250 Void Map now unlocks a toggle for AutoUpgrade where it buys everything but Coordinations. This will already be unlocked if you\'ve previously cleared a Z250 Void Map': '通过宇宙1区域250的虚空地图后，将解锁自动升级的新模式，可以自动购买协作以外的所有升级。如果您之前已经通过了相应的虚空地图，则会直接解锁。',
    'Added an \'M\' icon to the bottom of the Mutators screen to show some info about Blacksmithery, Hyperspeed, Liquification, and Overkill Zones in a tooltip': '在突变因子界面底部增加了一个“精”按钮，它可以显示关于锻铁术、风驰电掣、液化和超杀区域的相关信息。',
    'The left column of the Heirlooms Screen now gains a scrollbar if the screen size is too small to fit everything': '如果屏幕太小，传家宝界面左侧会出现一个滚动条。',
    'Added Atlantrimp to Map at Zone': '在自动进图中可以运行亚特兰蒂皮了。',
    'Time Warp is so much faster now that I\'ve added a slider to limit speed for anyone who likes to actively manage Time Warp. This slider can also be accessed by ctrl clicking the Offline Progress setting outside of Time Warp.': '时间跃迁的速度快了很多，因此我增加了一个滚动条，可以用于调节时间跃迁的速度。除了在时间跃迁界面调节以外，也可以按下Ctrl键再点击设置中的离线进度选项来调节。',
    'Cleaned up some Time Warp UI issues, speed no longer bounces around': '处理了时间跃迁的界面问题，速度不会再随意变动了。',
    'Added Observation\'s max levels to its tooltip': '在洞察特权的提示框中加上了它的等级上限。',
    'Added text to the tooltip showing how many bonfires have been built so far this run when running Hypothermia': '进行失温挑战时，可以查看本次挑战中一共建造了多少处篝火。',
    'Added how many fragments you currently have to the message that says you don\'t have enough fragments to create a map': '在碎片不足无法制造地图的消息中增加了您目前拥有的碎片数量。',
    'Added in a huge amount of bug fixes, performance improvements, and screen reader improvements thanks to Quia, August, and Noo Noo from Discord. Time Warp is noticeably faster and many areas of the game run much more efficiently!': '总之修复了一大堆错误，加快了游戏运行速度，感谢来自Discord的Quia、August和Noo Noo。时间跃迁速度显著变快，游戏很多区域运行得更加高效了！',
    'More than one Amalgamator can now spawn when clicking Fight at the start of a run in U1': '在宇宙1初始状态下点击战斗按钮后，可以同时出现多于1名合并者了。',
    'Nometal no longer has fast enemies': '异食挑战的敌人不再抢先攻击。',
    'Magmamancers are now properly unlocked upon completing Nometal': '完成异食挑战后可以正常解锁岩浆巫师。',
    'The achievement "Power Tower" can now be earned in Universe 2. If you previously lost this achievement by buying the 20th floor while in U2, it will be rewarded upon loading this patch': '您可以在宇宙2中正常获得成就“力量之塔”了。如果之前您在宇宙2中建造第二十层尖塔，导致没有获得这个成就，那么将在打开新版本游戏时直接获得该成就。',
    'Desolation wasn\'t actually making Map enemies fast even though they had the fast icon. Rather than making the challenge harder by making them actually fast, this line has been removed from the description and enemies no longer show the fast icon if they\'re not.': '荒凉挑战并未使地图中的敌人抢先攻击，尽管它们确实拥有相应的图标。与其修复错误让挑战难度增加，不如移除挑战描述中的相应内容，并使敌人不会错误显示相应图标。',
    'Bug enemies are no longer present on the Zone after completing Exterminate': '完成灭虫挑战后，虫子不会再出现在当前区域中了。',
    'The text in the input box for renaming heirlooms is now always black for readability': '重命名传家宝时，输入框的文本将保持黑色，以方便阅读。',
    'Liquification in U2 now respects your Liquification setting': '宇宙2中的液化变为根据设置中是否启用而定。',
    'Fixed a bug where Map at Zone wouldn\'t trigger the next line at the same cell after clearing Frozen Castle': '修复了自动进图在通过冻结城堡后没法在同一格子内切换到下一行设置的问题。',
    'Fixed an issue where all gathered resources were reduced by too much on the Desolation Challenge': '修复了荒凉挑战中资源获取量减少过多的问题。',
    'Explorer fragment gain is no longer being reduced while running the Desolation challenge': '进行荒凉挑战时，探险家的碎片获取量不再减少。',
    'Fixed an issue that could cause breed speed to go infinite post Spire completion': '修复了通过尖塔后，繁殖速度可能会变成无限大的问题。',
    'Fixed a crash that could occur by continually adding and removing buildings to the building queue': '修复了反复往建造队列增加和取消建筑可能导致游戏崩溃的问题。',
    'Fixed a bug that could cause player stats to go negative': '修复了可能导致我方脆皮属性变成负数的问题。',
    'The \'Pop Highest Heirloom\' setting now works properly with Spire Cores': '“弹出最高阶传家宝提示框”设置可以正确对尖塔核心生效了。',
    'Fixed an issue where tooltips could go offscreen vertically': '修复了提示框可能会垂直移至屏幕不可见区域的问题。',
    'Updated the Tenacity tooltip': '更新了坚持特权的提示框内容。',
    //#endregion
    //#region 5.9.2
    ...
    'Shards can be used to purchase Contracts for and Upgrade new items from this patch, or to upgrade a powerful new customizable bonus item called The Ring.': '您可以使用晶块来接受新合约，升级新物品，或者是升级新的自定义奖励物品，灵戒。',
    ...
    'Buildings queue handles multiple purchases much more gracefully': '建造队列可以更好处理多个建筑了。',
    ...
    'Structures queue no longer stacks items together.': '建造队列不再将建筑合并建造。',
    'Added \'seconds\' to structures queue progress bar': '建造队列进度条上增加了时间提示。',
    'Structures queue progress bar now shows the correct amount of time remaining after finding one or more foremen': '建造队列进度条可以在发现工头后正确更新时间了。',
