...
var cnItems = {
    ...
    'Capitalized "All" in the "Showing All Achieves" setting, fixed a typo in the Mastery Tab Alert setting tooltip': '使“显示所有成就”设置中的All变为首字母大写(中文无影响)，修复了专精页面设置提示框的文本错误。',
