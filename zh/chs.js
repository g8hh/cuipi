...
var cnItems = {
    ...
    'Size': '尺寸',
    'Tweak the portal to bring you to an alternate reality, where Trimps are bigger and stronger, to force yourself to figure out a way to build larger housing. Your Trimps will gather 50% more resources, but your housing will fit 50% fewer Trimps. If you complete The Dimension of Anger without disabling the challenge, your stats will return to normal.': '调节传送门，将您带到一个脆皮更大更强壮的实体中。在那里可以学习如何建造更大的房屋。您的脆皮可以多获取50%的资源，但住房少容纳50%的脆皮。如果您在没有放弃挑战的情况下通过了愤怒维度地图，那么一切将恢复正常。',
    'Tweak the portal to bring you to an alternate reality, where Trimps are bigger and stronger, to force yourself to figure out a way to build larger housing. Your Trimps will gather 50% more resources, but your housing will fit 50% fewer Trimps.': '调节传送门，将您带到一个脆皮更大更强壮的实体中。在那里可以学习如何建造更大的房屋。您的脆皮可以多获取50%的资源，但住房少容纳50%的脆皮。',
    'Size Challenge!': '尺寸挑战！',
    'You have unlocked a new perk, and your Trimps have been reduced down to their normal size.': '您解锁了一个新的特权，并且脆皮又回到了正常尺寸。',
    'You have the Size challenge active. Tweak the portal to bring you to an alternate reality, where Trimps are bigger and stronger, to force yourself to figure out a way to build larger housing. Your Trimps will gather 50% more resources, but your housing will fit 50% fewer Trimps. If you complete The Dimension of Anger without disabling the challenge, your stats will return to normal.': '您目前激活了尺寸挑战。调节传送门，将您带到一个脆皮更大更强壮的实体中。在那里可以学习如何建造更大的房屋。您的脆皮可以多获取50%的资源，但住房少容纳50%的脆皮。如果您在没有放弃挑战的情况下通过了愤怒维度地图，那么一切将恢复正常。',
    'You have the Size challenge active. "Tweak the portal to bring you to an alternate reality, where Trimps are bigger and stronger, to force yourself to figure out a way to build larger housing. Your Trimps will gather 50% more resources, but your housing will fit 50% fewer Trimps."': '您目前激活了尺寸挑战。调节传送门，将您带到一个脆皮更大更强壮的实体中。在那里可以学习如何建造更大的房屋。您的脆皮可以多获取50%的资源，但住房少容纳50%的脆皮。',
    'Balance': '平衡',
	...
	'Zone': '区域',
    'with this challenge active will grant an additional 100% of all helium earned up to that point. This challenge is repeatable!': '，将额外获得本轮游戏到目前为止氦获取量100%的氦。此挑战可重复完成！',
    ...
    'Electricity': '电流',
	'Use the keys you found in the Prison to bring your portal to an extremely dangerous dimension. In this dimension enemies will electrocute your Trimps, stacking a debuff with each attack that damages Trimps for 10% of total health per turn per stack, and reduces Trimp attack by 10% per stack. Clearing': '使用监狱地图中找到的钥匙，可以将您的传送门导向一个极端危险的维度。此维度中，敌人会电击您的脆皮，给它们叠加一层“触电”。每层触电在每轮受到每次攻击时对脆皮造成生命值上限10%的伤害，并且降低脆皮10%攻击力。通过 ',
	'\'The Prison\' (': '监狱地图 (',
	'will reward you with an additional 200% of all helium earned up to but not including Zone 80. This is repeatable!': '，将额外获得本轮游戏到目前为止氦获取量200%的氦(不包含区域80)。此挑战可重复完成！',
    'Use the keys you found in the Prison to bring your portal to an extremely dangerous dimension. In this dimension enemies will electrocute your Trimps, stacking a debuff with each attack that damages Trimps for 10% of total health per turn per stack, and reduces Trimp attack by 10% per stack.': '使用监狱地图中找到的钥匙，可以将您的传送门导向一个极端危险的维度。此维度中，敌人会电击您的脆皮，给它们叠加一层“触电”。每层触电在每轮受到每次攻击时对脆皮造成生命值上限10%的伤害，并且降低脆皮10%攻击力。',
    ...
    'Produce a Calming Aura from your Portal Device, reducing the Attack of Bad Guys AND Trimps by 10% (compounding). You can enable Equality Scaling, which causes Equality to start inactive and gain one level each time your Trimps die up to your purchased Perk level.': '用传送门装置发出一个镇静力场，减少脆皮和敌人10%的攻击力(相互叠乘)。您也可以激活平等缩放，激活后，平等在一开始不生效，脆皮每阵亡一次，平等效果增加一级，最高等于您的平等特权等级。',
	'Carpentry': '木工',
    ...
    'Crystallize some Radon, creating an interdimensional Prism that you can carry back through Portals. Each level adds 1% to your Trimps\' Prismatic Shield and makes your Trimps feel 5% more comfortable in battle. Once you have 20 or more points of Prismal, you will automatically collect Prismalicious from the Prismatic Palace after completing Z20.': '将一些氡晶化，制造一个超次元的棱镜，这样就可以带着它通过传送门了。每级增加1%的棱镜护盾，并且可以使您的脆皮在战斗中舒适度增加5%（译者注：后半句无实际效果）。当棱镜化特权等级到达20级以上后，您就可以在通过区域20后自动获得棱镜宫殿的优质棱镜升级。',
    '': '',
    '': '',
    //特权相关结束
    //专精相关
