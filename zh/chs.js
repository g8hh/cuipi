...
var cnItems = {
    ...
    'without failing will complete this Challenge - granting an additional 300% of all Radon earned up to that point. Failing this Challenge will grant an additional 100% of all Radon earned up to the spot where you failed.': '后可以完成此挑战，额外获得本轮游戏到目前为止氡获取量300%的氡。挑战失败的话，将额外获得获得本轮游戏到失败为止氡获取量100%的氡。',
    ...
    'or': ' 或者',
    'will complete this Challenge - granting an additional 400% of all Radon collected through Z50. This Challenge is repeatable!': '后可以完成此挑战，额外获得本轮游戏到区域50为止氡获取量400%的氡。此挑战可重复完成！',
