...
var cnItems = {
    ...
    'Send your misbehaving Trimps to the mines for some therapeutic work. Each Miner can find and smelt 0.50 bars of metal per second.': '将行为不端的脆皮送到地雷进行一些治疗工作。 每个矿工每秒可以发现和冶炼0.50金属条。',
...
var cnRegReplace = new Map([
    ...
    [/^wood: (.+) \((.+) Years (.+) Days$/, '木头：$1 \($2 年 $3 天'],
    [/^food: (.+) \((.+) Min (.+) Sec$/, '食物：$1 \($2 分 $3 秒'],
    [/^wood: (.+) \((.+) Min (.+) Sec$/, '木头：$1 \($2 分 $3 秒'],
    [/^wood: (.+) \((.+) Sec$/, '木头：$1 \($2 秒'],
