...
var cnItems = {
    ...
    'You can pause the game by clicking the run timer in the bottom right of the screen. This setting allows you to remove that ability!': '你可以点击右下角的计时器来暂停游戏。此设置决定是否关闭此功能！',
    'Delete Save': '删除存档',
