...
var cnItems = {
    ...
    'until that enemy dies (maximum of': ' ，直到敌人死亡（最大',
    'stacks). This bonus does not apply to Fragments, and the helium bonus does not apply to maps.': '层）。碎片不受加成，地图中的氦也一样不受加成。',
