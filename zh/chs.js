...
var cnItems = {
    ...
    'You have the Discipline challenge active. Tweak the portal to bring you back to a universe where Trimps are less disciplined, in order to teach you how to be a better Trimp trainer. Your Trimps\' minimum damage will be drastically lower, but their high end damage will be considerably higher. Completing The Dimension Of Anger will cause Trimp damage to return to normal.': '您目前激活了纪律挑战。调节传送门，将您带到一个脆皮不那么有纪律的宇宙。在那里可以学习如何成为一个更好的脆皮训练师。您的脆皮最低伤害将大大降低，但最高伤害也会大大增加。通过愤怒维度地图后，脆皮的伤害将恢复正常。',
    'You have the Discipline challenge active. "Tweak the portal to bring you back to a universe where Trimps are less disciplined, in order to teach you how to be a better Trimp trainer. Your Trimps\' minimum damage will be drastically lower, but their high end damage will be considerably higher."': '您目前激活了纪律挑战。调节传送门，将您带到一个脆皮不那么有纪律的宇宙。在那里可以学习如何成为一个更好的脆皮训练师。您的脆皮最低伤害将大大降低，但最高伤害也会大大增加。通过愤怒维度地图后，脆皮的伤害将恢复正常。',
    'You will unlock this challenge once you have 30 total Helium': '欲解锁此挑战，您需要一共获得30氦',
    'Metal': '金属',
    'Tweak the portal to bring you to an alternate reality, where the concept of Miners does not exist, to force yourself to become frugal with equipment crafting strategies. If you complete The Dimension Of Anger without disabling the challenge, miners will re-unlock.': '调节传送门，将您带到一个不存在矿工这个概念的实体中。在那里可以学习在锻造装备时如何更勤俭节约。如果您在没有放弃挑战的情况下通过了愤怒维度地图，那么矿工将重新解锁。',
    'Tweak the portal to bring you to alternate reality, where the concept of Miners does not exist, to force yourself to become frugal with equipment crafting strategies.': '调节传送门，将您带到一个不存在矿工这个概念的实体中。在那里可以学习在锻造装备时如何更勤俭节约。',
    'Metal Challenge!': '金属挑战！',
    'You have unlocked a new perk, and Miners have returned to your game.': '您解锁了一个新的特权，并且矿工们又回到了游戏中。',
    'You have the Metal challenge active. Tweak the portal to bring you to an alternate reality, where the concept of Miners does not exist, to force yourself to become frugal with equipment crafting strategies. If you complete The Dimension Of Anger without disabling the challenge, miners will re-unlock.': '您目前激活了金属挑战。调节传送门，将您带到一个不存在矿工这个概念的实体中。在那里可以学习在锻造装备时如何更勤俭节约。如果您在没有放弃挑战的情况下通过了愤怒维度地图，那么矿工将重新解锁。',
    'You have the Metal challenge active. "Tweak the portal to bring you to alternate reality, where the concept of Miners does not exist, to force yourself to become frugal with equipment crafting strategies."': '您目前激活了金属挑战。调节传送门，将您带到一个不存在矿工这个概念的实体中。在那里可以学习在锻造装备时如何更勤俭节约。如果您在没有放弃挑战的情况下通过了愤怒维度地图，那么矿工将重新解锁。',
    'Size': '尺寸',
    'Tweak the portal to bring you to an alternate reality, where Trimps are bigger and stronger, to force yourself to figure out a way to build larger housing. Your Trimps will gather 50% more resources, but your housing will fit 50% fewer Trimps. If you complete The Dimension of Anger without disabling the challenge, your stats will return to normal.': '调节传送门，将您带到一个脆皮更大更强壮的实体中。在那里可以学习如何建造更大的房屋。脆皮可以多获取50%的资源，但住房少容纳50%的脆皮。如果您在没有放弃挑战的情况下通过了愤怒维度地图，那么一切将恢复正常。',
    'Tweak the portal to bring you to an alternate reality, where Trimps are bigger and stronger, to force yourself to figure out a way to build larger housing. Your Trimps will gather 50% more resources, but your housing will fit 50% fewer Trimps.': '调节传送门，将您带到一个脆皮更大更强壮的实体中。在那里可以学习如何建造更大的房屋。脆皮可以多获取50%的资源，但住房少容纳50%的脆皮。',
    'Size Challenge!': '尺寸挑战！',
    'You have unlocked a new perk, and your Trimps have been reduced down to their normal size.': '您解锁了一个新的特权，并且脆皮又回到了正常尺寸。',
    'You have the Size challenge active. Tweak the portal to bring you to an alternate reality, where Trimps are bigger and stronger, to force yourself to figure out a way to build larger housing. Your Trimps will gather 50% more resources, but your housing will fit 50% fewer Trimps. If you complete The Dimension of Anger without disabling the challenge, your stats will return to normal.': '您目前激活了尺寸挑战。调节传送门，将您带到一个脆皮更大更强壮的实体中。在那里可以学习如何建造更大的房屋。脆皮可以多获取50%的资源，但住房少容纳50%的脆皮。如果您在没有放弃挑战的情况下通过了愤怒维度地图，那么一切将恢复正常。',
    'You have the Size challenge active. "Tweak the portal to bring you to an alternate reality, where Trimps are bigger and stronger, to force yourself to figure out a way to build larger housing. Your Trimps will gather 50% more resources, but your housing will fit 50% fewer Trimps."': '您目前激活了尺寸挑战。调节传送门，将您带到一个脆皮更大更强壮的实体中。在那里可以学习如何建造更大的房屋。脆皮可以多获取50%的资源，但住房少容纳50%的脆皮。',
    'Balance': '平衡',
	...
	'Zone': '区域',
    'with this challenge active will grant an additional 100% of all helium earned up to that point. This challenge is repeatable!': '后，将额外获得本轮游戏到目前为止氦获取量100%的氦。此挑战可重复完成！',
    ...
    'You have the Balance challenge active. Your scientists have discovered a chaotic dimension filled with helium. All enemies have 100% more health, enemies in world deal 17% more damage, and enemies in maps deal 135% more damage. Starting at Zone 6, every time an enemy in the world is slain you will gain a stack of \'Unbalance\'. Every time an enemy in a map is slain, you will lose a stack of Unbalance. Each stack of Unbalance reduces your health by 1%, but increases your Trimps\' gathering speed by 1%. Unbalance can only stack to 250. Completing': '您目前激活了平衡挑战。您的科学家发现了一个充满氦的混沌维度。所有敌人生命值增加100%，多造成17%伤害，并且地图中的敌人增加135%伤害。从区域6开始，每在世界上杀死一名敌人，您获得一层“不平衡”。而每在地图中杀死一名敌人，您失去一层“不平衡”。每层不平衡减少1%生命值，但增加脆皮1%资源获取速度。不平衡最高叠加到250层。在此挑战激活的前提下通过 ',
    'You have the Balance challenge active. "Your scientists have discovered a chaotic dimension filled with unharvestable but pretty helium. All enemies have 100% more health, enemies in world deal 17% more damage, and enemies in maps deal 135% more damage. Starting at Zone 6, every time an enemy in the world is slain you will gain a stack of \'Unbalance\'. Every time an enemy in a map is slain, you will lose a stack of Unbalance. Each stack of Unbalance reduces your health by 1%, but increases your Trimps\' gathering speed by 1%. Unbalance can only stack to 250."': '您目前激活了平衡挑战。您的科学家发现了一个充满了氦的混沌维度，这个维度中的氦虽然量很大，但无法收集。所有敌人生命值增加100%，多造成17%伤害，并且地图中的敌人增加135%伤害。从区域6开始，每在世界上杀死一名敌人，您获得一层“不平衡”。而每在地图中杀死一名敌人，您失去一层“不平衡”。每层不平衡减少1%生命值，但增加脆皮1%资源获取速度。不平衡最高叠加到250层。',
    'Scientist': '科学家',
    'Scientist II': '科学家 II',
    ...
    'You have the Scientist challenge active. Attempt modifying the portal to retain positive qualities from previous dimensions. Until you perfect the technique, you will start with': '您目前激活了科学家挑战。尝试调节传送门来保持之前维度的正面效果。直到您对这项技艺足够精进之前，您将从 ',
    'You have the Scientist challenge active. Attempt modifying the portal to harvest resources when travelling. Until you perfect the technique, you will start with': '您目前激活了科学家挑战。尝试调节传送门来在旅途中获取资源。直到您对这项技艺足够精进之前，您将从 ',
    'Meditate': '冥想',
    ...
    'You have the Meditate challenge active. Visit a dimension where everything is stronger, in an attempt to learn how to better train your Trimps. All enemies will have +100% health and +50% attack, but your Trimps will gather 25% faster. Completing': '您目前激活了冥想挑战。进入一个敌人更加强大的维度来学习如何更好地训练脆皮。所有的敌人生命值增加100%，攻击力增加50%，但脆皮的资源获取速度也会提高25%。通过 ',
    'You have the Meditate challenge active. Visit a dimension where everything is stronger, in an attempt to learn how to better train your Trimps. All enemies will have +100% health and +50% attack, but your Trimps will gather 25% faster.': '您目前激活了冥想挑战。进入一个敌人更加强大的维度来学习如何更好地训练脆皮。所有的敌人生命值增加100%，攻击力增加50%，但脆皮的资源获取速度也会提高25%。',
    'Decay': '衰变',
    'Tweak the portal to bring you to an alternate reality, where added chaos will help you learn to create a peaceful place. You will gain 10x loot (excluding helium), 10x gathering, and 5x Trimp attack, but a stack of Decay will accumulate every second. Each stack of Decay reduces loot, gathering, and Trimp attack by 0.5% of the current amount. These stacks reset each time a Blimp is killed and cap at 999. Completing': '调节传送门，将您带到一个更混乱的实体中。在那里可以学习如何创造一个更安宁的环境。您的战利品获取量变为10倍(氦除外)，资源获取速度变为10倍，且脆皮的攻击力变为5倍，但每秒都会增加一层“衰变”。每层衰变将战利品获取量、资源获取速度和脆皮攻击力减少当前数量的0.5%。当杀死每个区域最后的脆皮大块头时层数重置，层数最高为999。在此挑战激活的前提下通过 ',
    ...
    'You have the Decay challenge active. Tweak the portal to bring you to an alternate reality, where added chaos will help you learn to create a peaceful place. You will gain 10x loot (excluding helium), 10x gathering, and 5x Trimp attack, but a stack of Decay will accumulate every second. Each stack of Decay reduces loot, gathering, and Trimp attack by 0.5% of the current amount. These stacks reset each time a Blimp is killed and cap at 999. Completing': '您目前激活了衰变挑战。调节传送门，将您带到一个更混乱的实体中。在那里可以学习如何创造一个更安宁的环境。您的战利品获取量变为10倍(氦除外)，资源获取速度变为10倍，且脆皮的攻击力变为5倍，但每秒都会增加一层“衰变”。每层衰变将战利品获取量、资源获取速度和脆皮攻击力减少当前数量的0.5%。当杀死每个区域最后的脆皮大块头时层数重置，衰变最高为999层。在此挑战激活的前提下通过 ',
    'Trimp': '脆皮',
    ...
    'You have the Trimp challenge active. Tweak the portal to bring you to a dimension where Trimps explode if more than 1 fights at a time. You will not be able to learn Coordination, but completing': '您目前激活了脆皮挑战。调节传送门，将您带到一个脆皮只能单打独斗的维度中。您将无法研究协作，但通过 ',
    'You have the Trimp challenge active. "Tweak the portal to bring you to a dimension where Trimps explode if more than 1 fights at a time. You will not be able to learn Coordination."': '您目前激活了脆皮挑战。调节传送门，将您带到一个脆皮只能单打独斗的维度中。您将无法研究协作。',
    'Trapper': '捕手',
    ...
    'bored': '无所事事',
    'breeding': '繁殖中',
    'You have the Trapper challenge active. Travel to a dimension where Trimps refuse to breed in captivity, teaching yourself new ways to take advantage of situations where breed rate is low. Clearing': '您目前激活了捕手挑战。前往一个被抓住的脆皮拒绝繁殖的维度。在那里可以学习如何利用低繁殖率做些什么。在此挑战激活的前提下通过 ',
    'You have the Trapper challenge active. "Travel to a dimension where Trimps refuse to breed in captivity, good luck!"': '您目前激活了捕手挑战。前往一个被抓住的脆皮拒绝繁殖的维度，祝您好运！',
    'Electricity': '电流',
	...
	'\'The Prison\' (': '监狱地图 (',
	'will reward you with an additional 200% of all helium earned up to but not including Zone 80. This is repeatable!': '后，将额外获得本轮游戏到目前为止氦获取量200%的氦(不包含区域80)。此挑战可重复完成！',
    ...
    'You have the Frugal challenge active. Bring yourself to a dimension where Equipment is cheap but unable to be prestiged, in order to teach yourself better resource and equipment management. Completing': '您目前激活了节俭挑战。将您带到一个装备更便宜但无法重铸的维度。在那里可以学习如何更好管理资源和装备。在此挑战激活的前提下通过 ',
    'Life': '生命',
	...
	'will reward you with an additional 400% of all helium earned up to that point. This is repeatable!': '后，将额外获得本轮游戏到目前为止氦获取量400%的氦。此挑战可重复完成！',
    'You have the Life challenge active. Explore a dimension that is normally populated by the Undead, but is currently plagued by a quickly moving virus that can bring things back to life. All enemies in this dimension have 500% extra attack and 1000% extra health. Attacking a normal undead enemy gives your Trimps 1 stack of Unliving, which increases Trimp attack and health by 10% (additive) per stack. Trimps can have a maximum of 150 stacks of Unliving, and attacking a Living enemy will remove 5 stacks of Unliving. Completing': '您目前激活了生命挑战。探索一个亡灵盘据的维度，最近此维度一种能够令亡灵复生的病毒正快速传播中。此维度中的所有敌人生命值增加1000%，攻击力增加500%。攻击一个普通的亡灵敌人可以使您的脆皮获得一层“亡灵化”，每层可以使脆皮的攻击力和生命值增加10%(相互叠加)。亡灵化最高为150层。攻击一个非亡灵的敌人将失去5层“亡灵化”。通过 ',
    'Mapocalypse': '天启地图',
    ...
    'You have the Mapocalypse challenge active. Experience a slightly distorted version of the \'Electricity\' dimension, to help understand the relationship between maps and the world. Everything will work exactly the same as Electricity, but all maps will have an extra 300% difficulty. Clearing': '您目前激活了天启地图挑战。体验一个轻微扭曲的“电流”维度。在那里可以更好理解地图与世界之间的关系。除了所有地图难度增加300%以外，大部分规则与电流挑战相同。通过 ',
    'Coordinate': '协同',
    ...
    'You have the Coordinate challenge active. Visit a dimension where Bad Guys are Coordinated but never fast, to allow you to study naturally evolved Coordination. Completing': '您目前激活了协同挑战。造访一个敌人协同作战但没有快速效果的维度。在那里可以研究自然进化出的协作是什么样的。在此挑战激活的前提下通过 ',
    'You have the Coordinate challenge active. "Visit a dimension where Bad Guys are Coordinated but never fast, chip \'em down!"': '您目前激活了协同挑战。造访一个敌人协同作战但没有快速效果的维度。嫩死他们！',
    'Crushed': '粉碎',
    ...
    'will reward you with an additional 400% of all helium earned up to but not including Z125. This challenge is repeatable.': '后，将额外获得本轮游戏到目前为止氦获取量400%的氦(不包含区域125)。此挑战可重复完成。',
    'You have the Crushed challenge active. Journey to a dimension where the atmosphere is rich in helium, but Bad Guys have a 50% chance to Critical Strike for +400% damage unless your Block is as high as your current Health. Clearing': '您目前激活了粉碎挑战。前往一个大气中富含氦的维度，此维度中除非您的格挡达到当前生命值，否则敌人有50%概率暴击，多造成400%伤害。通过 ',
    'Slow': '迟缓',
    ...
    'You have the Slow challenge active. Legends tell of a dimension inhabited by incredibly fast Bad Guys, where blueprints exist for a powerful yet long forgotten weapon and piece of armor. All Bad Guys will attack first in this dimension, but clearing': '您目前激活了迟缓挑战。传说这个维度被极其迅捷的敌人占据了，另外这里还有着强大的武器及护甲的蓝图，就等着您来让它们重见天日了。此维度中，所有敌人都会抢先攻击，但在此挑战激活的前提下通过 ',
    'You have the Slow challenge active. "Legends tell of a dimension inhabited by incredibly fast Bad Guys, and you seem to want to go there to prove something. All Bad Guys will attack first in this dimension, watch your health!"': '您目前激活了迟缓挑战。传说这个维度被极其迅捷的敌人占据了，您看起来也想要证明自己。此维度中，所有敌人都会抢先攻击，注意您的生命值！',
    'Nom': '美味',
    ...
    'will reward you with an additional 450% of all helium earned up to that point. This is repeatable!': '后，将额外获得本轮游戏到目前为止氦获取量450%的氦。此挑战可重复完成！',
    ...
    'You have the Nom challenge active. Travel to a dimension where Bad Guys enjoy the taste of Trimp. Whenever a group of Trimps dies, the Bad Guy will eat them, gaining 25% (compounding) more attack damage and healing for 5% of their maximum health. The methane-rich atmosphere causes your Trimps to lose 5% of their total health after each attack, but the Bad Guys are too big and slow to attack first. Clearing': '您目前激活了美味挑战。前往一个敌人垂涎于脆皮美味的维度。当一队脆皮死亡后，敌人会将它们吃掉，攻击力增加25%(叠乘)，且恢复生命值上限5%的生命值。另外，此维度富含甲烷的大气还会使脆皮在每次攻击后失去生命值上限5%的生命值。不过，敌人体型太大，行动太迟缓，因此它们无法抢先攻击。通过 ',
    'You have the Nom challenge active. "Travel to a dimension where Bad Guys enjoy the taste of Trimp. Whenever a group of Trimps dies, the Bad Guy will eat them, gaining 25% (compounding) more attack damage and healing for 5% of their maximum health. The methane-rich atmosphere causes your Trimps to lose 5% of their total health after each attack, but the Bad Guys are too big and slow to attack first."': '您目前激活了美味挑战。前往一个敌人垂涎于脆皮美味的维度。当一队脆皮死亡后，敌人会将它们吃掉，攻击力增加25%(叠乘)，且恢复生命值上限5%的生命值。另外，此维度富含甲烷的大气还会使脆皮在每次攻击后失去生命值上限5%的生命值。不过，敌人体型太大，行动太迟缓，因此它们无法抢先攻击。',
    'Mapology': '地图学',
    ...
    'with this challenge active will reward you with an additional 400% of all helium earned up to that point. This is repeatable!': '后，将额外获得本轮游戏到目前为止氦获取量400%的氦。此挑战可重复完成！',
    ...
    'You have the Toxicity challenge active. Travel to a dimension rich in helium, but also rich in toxic Bad Guys. All Bad Guys have 5x attack and 2x health. Each time you attack a Bad Guy, your Trimps lose 5% of their health, and toxins are released into the air which reduce the breeding speed of your Trimps by 0.3% (of the current amount), but also increase all resources obtained by 0.15% (including Helium), stacking up to 1500 times. These stacks will reset when you clear a Zone. Completing': '您目前激活了毒性挑战。前往一个富含氦，但也富含大量毒性敌人的维度。所有敌人攻击力变为5倍，生命值变为2倍。每次攻击一个毒性敌人后，脆皮失去5%的生命值，同时毒气排入大气后脆皮繁殖速度会比之前的速度慢0.3%，但资源获取量也会增加0.15%(包括氦)，此效果最高为1500层。在通过一个区域后层数重置。在此挑战激活的前提下通过 ',
    'You have the Toxicity challenge active. "Travel to a dimension filled with the glory that comes from killing toxic Bad Guys. All Bad Guys have 5x attack and 2x health. Each time you attack a Bad Guy, your Trimps lose 5% of their health, and toxins are released into the air which reduce the breeding speed of your Trimps by 0.3% (of the current amount), but also increase all loot found by 0.15%, stacking up to 1500 times. These stacks will reset when you clear a Zone."': '您目前激活了毒性挑战。前往一个以击杀毒性敌人为荣的维度。所有敌人攻击力变为5倍，生命值变为2倍。每次攻击一个毒性敌人后，脆皮失去5%的生命值，同时毒气排入大气后脆皮繁殖速度会比之前的速度慢0.3%，但资源获取量也会增加0.15%(包括氦)，此效果最高为1500层。在通过一个区域后层数重置。',
    'Devastation': '破坏',
    ...
    'You have the Devastation challenge active. Travel to a harsh dimension where Trimps are penalized for the mistakes of previous generations. If your army is killed at any point, any overkill damage will be applied 750% to the next group of Trimps to fight. Completing': '您目前激活了破坏挑战。前往一个脆皮要为前辈们错误买单的严苛维度。如果军队被敌人击杀，下一队脆皮将受到超杀伤害750%的伤害。通过 ',
    'Watch': '守望',
    ...
    'with this challenge active will reward you with an additional 200% of all helium earned up to that point.': '后，将额外获得本轮游戏到目前为止氦获取量200%的氦。',
    ...
    'You have the Watch challenge active. Travel to a strange dimension where life is easier but harder at the same time. At the end of each World Zone any available equipment upgrades will drop, and any unassigned Trimps will be split evenly amongst Farmer, Lumberjack, and Miner. However, resource production and drops from all sources will be halved, and all enemies will deal 25% more damage. Completing': '您目前激活了守望挑战。前往一个生活既轻松又艰难的奇怪维度。通过每个区域后，自动获得所有可用的装备重铸升级，且所有未分配工作的脆皮自动平均分配到农民、伐木工和矿工。但是，所有资源获取速度减半，且敌人造成的伤害增加25%。在此挑战激活的前提下通过 ',
    'You have the Watch challenge active. "Travel to a strange dimension where life is easier but harder at the same time. At the end of each World Zone any available equipment upgrades will drop, and any unassigned Trimps will be split evenly amongst Farmer, Lumberjack, and Miner. However, resource production and drops from all sources will be halved, and all enemies will deal 25% more damage. Relax and let the Trimps figure it out for themselves, you know you want to."': '您目前激活了守望挑战。前往一个生活既轻松又艰难的奇怪维度。通过每个区域后，自动获得所有可用的装备重铸升级，且所有未分配工作的脆皮自动平均分配到农民、伐木工和矿工。但是，所有资源获取速度减半，且敌人造成的伤害增加25%。您知道您本来就想着打打酱油，看着脆皮们自己来就好了。',
    'Lead': '领导',
    ...
    'with this challenge active will reward you with an additional 300% of all helium earned up to that point.': '后，将额外获得本轮游戏到目前为止氦获取量300%的氦。',
    ...
    'You have the Lead challenge active. Travel to a dimension where life is easier or harder depending on the time. Odd numbered Zones will cause double resources to be earned from all sources, and will give your Trimps 50% extra attack. Starting an even numbered Zone will cause all enemies to gain 200 stacks of': '您目前激活了领导挑战。前往一个难度由时间决定的维度。在奇数区域中，脆皮资源获取量翻倍，且攻击力提高50%。在偶数区域中，所有敌人获得200层 ',
    'You have the Lead challenge active. "Travel to a dimension where life is easier or harder depending on the time. Odd numbered Zones will cause double resources to be earned from all sources, and will give your Trimps 50% extra attack. Starting an even numbered Zone will cause all enemies to gain 200 stacks of': '您目前激活了领导挑战。前往一个难度由时间决定的维度。在奇数区域中，脆皮资源获取量翻倍，且攻击力提高50%。在偶数区域中，所有敌人获得200层 ',
    '. Clearing a World cell will cause 1 stack to be lost, and each stack will increase the enemy\'s damage and health by 4%, and block pierce by 0.1%. If your Trimps attack without killing their target, they will lose 0.03% of their health per enemy stack."': ' 。在世界中通过一个格子后敌人失去一层动量，每层动量增加敌人4%的伤害和生命值，并且防御穿透增加0.1%。如果脆皮攻击后没能击杀敌人，它们将根据动量层数，每层受到0.03%生命值的伤害。',
    'Corrupted': '腐化',
    'with this challenge active will reward you with an extra 200% helium earned from any source up to that point, and will instantly transport you back to your normal dimension.': '后，将额外获得本轮游戏到目前为止氦获取量200%的氦，并立刻将您送回原来的维度。',
    'Domination': '统治',
    ...
    'will also reward you with an extra 100% of helium earned from any source up to that point, and will instantly teleport you back to your normal dimension!': '后，将额外获得本轮游戏到目前为止氦获取量100%的氦，并立刻将您送回原来的维度！',
    'You have the Domination challenge active. Travel to a dimension where the strongest Bad Guys gain strength from those weaker than them. Most Bad Guys have 90% less health and attack, but the final Bad Guy in every World Zone and Map has 2.5x more damage, 7.5x more health, and heals for 5% every time they attack your Trimps. But they also drop three times as much Helium! Clearing': '您目前激活了统治挑战。前往一个最强的敌人从比它们弱小的敌人处吸收力量的维度。大部分敌人的生命值和攻击力减少90%，但每个区域最后一个敌人的伤害变为2.5倍，生命值变为7.5倍，且每次攻击的时候恢复5%的生命值。虽然如此，它们也会掉落三倍的氦！通过 ',
    'Obliterated': '抹杀',
    ...
    'You have the Obliterated challenge active. "Against your better judgement, travel to a dimension that\'s simply just not very friendly. Liquimps are unable to liquify, enemies have 1.00e12x attack and health, and equipment is 1.00e12x more expensive. Every 10 Zones, enemy attack and health will increase by another 10x."': '您目前激活了抹杀挑战。前往一个对您完全不友好的维度，您知道的，这不是什么好主意。此维度中无法进行液化，敌人的攻击力和生命值为正常的1e12倍，装备成本为正常的1e12倍。每通过10层，敌人的攻击力和生命值还会再变为之前的10倍。',
    'Eradicated': '灭绝',
    ...
    'You have the Eradicated challenge active. "If you thought Obliterated was not very friendly, wait until you see this dimension! Liquimps are unable to liquify, enemies have 1.00e20x attack and health, and equipment is 1.00e20x more expensive. Every 2 Zones, enemy attack and health will increase by another 3x.': '您目前激活了灭绝挑战。如果抹杀挑战已经让您感受到世界的恶意，那么这个挑战可能会让您怀疑人生。此维度中无法进行液化，敌人的攻击力和生命值为正常的1e20倍，装备成本为正常的1e20倍。每通过2层，敌人的攻击力和生命值还会再变为之前的3倍。',
    ...
    'Agility': '敏捷',
    'Crank your portal into overdrive, increasing the clock speed of the Universe. Each level reduces the time between Trimp and Bad Guy attacks by': '把您的传送门调成超速，增加宇宙中的时间流速。把你的传送门搞成超速，需要额外的氦，但是增加了宇宙的时钟速度。每级可使脆皮与敌人的攻击间隔比上一级减少',
    ...
    'Start every post-magma Zone with an additional 60 seconds of credit already applied to your Magmamancers per Spire row completed this run. In addition, every 2 Spires you complete this run increases the maximum time that Magmamancers can stack by 10 minutes!': '本轮游戏中每通过1行尖塔，进入岩浆以后的区域时岩浆巫师就额外获得60秒的加成。另外，本轮游戏每完成2个尖塔，岩浆巫师的时间上限就增加10分钟。',
    ...
    's that have normal reward scaling (Does not include Trappapalooza, Trapper, Coordinate, Trimp, Obliterated or Eradicated).': '中奖励递增正常的生效(不包括捕手盛宴、捕手、协同、脆皮、抹杀、灭绝)。',
...
var cnRegReplace = new Map([
    ...
    [/^(.*)You have completed the$/, '$1您已完成了 '], //通用挑战完成消息
    [/^(.*)You have completed the Balance challenge! You have been rewarded with (.*) Helium, and you may repeat the challenge.$/, '$1您已完成了平衡挑战！您获取了 $2 氦，现在您又可以继续开始此挑战了。'], //平衡挑战完成信息
	[/^(.*)You can research science again!$/, '$1您又可以进行科学研究了！'], //科学家挑战放弃消息
    [/^(.*)You have completed the 'Meditate' challenge! The dimension has returned to normal, and you have unlocked a new perk!$/, '$1您已完成了 冥想 挑战！这个维度恢复到了正常，而且您解锁了一个新的特权！'], //冥想挑战完成消息
    [/^(.*)You have completed the Decay challenge! All stats have been returned to normal, and you can now create more powerful Gardens maps at will!$/, '$1您已完成了 衰变 挑战！一切都恢复了正常，而且您可以随意制造更强大的花园地图了！'], //衰变挑战完成消息
    [/^(.*)You have completed the 'Trapper' challenge! Your Trimps now remember how to breed, and you have unlocked a new perk!$/, '$1您已完成了 捕手 挑战！您的脆皮想起来如何繁殖了，而且您解锁了一个新的特权！'], //捕手挑战完成消息
    [/^(.*)You have completed the Electricity challenge! You have been rewarded with (.*) Helium, and you may repeat the challenge.$/, '$1您已完成了电流挑战！您获取了 $2 氦，现在您又可以继续开始此挑战了。'], //电流挑战完成信息
    [/^(.*)You have completed the 'Frugal' challenge! You can once again find equipment upgrades in maps, and Megabooks now increase gather rates by an extra 10%!$/, '$1您已完成了 节俭 挑战！您又可以获得重铸升级了，而且超级升级的资源获取速度额外提升10%！'], //节俭挑战完成信息
    [/^(.*)You have completed the Life challenge! You have been rewarded with (.*) Helium, and you may repeat the challenge.$/, '$1您已完成了生命挑战！您获取了 $2 氦，现在您又可以继续开始此挑战了。'], //生命挑战完成信息
    [/^(.*)You have completed the Mapocalypse challenge! You have unlocked the 'Siphonology' Perk, and have been rewarded with (.*) Helium.$/, '$1您已完成了天启地图挑战！您解锁了 虹吸学 特权，并且获取了 $2 氦。'], //天启地图挑战完成信息
    [/^(.*)You have completed the 'Coordinate' challenge! The Bad Guys on this world no longer fight together, and have regained their speed. You have unlocked the 'Coordinated' perk!$/, '$1您已完成了 协同 挑战！世界上的敌人不再协同作战了，并且又可以获得快速效果了。您解锁了 协同 特权！'], //协同挑战完成信息
    [/^Bionic Wonderland (.+)$/, '仿生仙境 $1'], //粉碎挑战等
    [/^(.*)You have completed the Crushed challenge! You have been rewarded with (.*) Helium.$/, '$1您已完成了粉碎挑战！您获取了 $2 氦。'], //粉碎挑战完成信息
    [/^(.*)You have completed the Slow challenge! You have found the patterns for the Gambeson and the Arbalest!$/, '$1您已完成了迟缓挑战！您学会了制造棉甲和强弩！'], //迟缓挑战完成信息
    [/^(.*)You have completed the Nom challenge! You have been rewarded with (.*) Helium, and you may repeat the challenge.$/, '$1您已完成了美味挑战！您获取了 $2 氦，现在您又可以继续开始此挑战了。'], //美味挑战完成信息
    [/^(.*)You have completed the Mapology challenge! You have unlocked the 'Resourceful' Perk! Cheaper stuff!$/, '$1您已完成了地图学挑战！您解锁了 足智多谋 特权！物美价廉！'], //地图学挑战完成信息
    [/^(.*)You have completed the Toxicity challenge! You have been rewarded with (.*) Helium, and you may repeat the challenge.$/, '$1您已完成了毒性挑战！您获取了 $2 氦，现在您又可以继续开始此挑战了。'], //毒性挑战完成信息
    [/^(.*)You have completed the Devastation challenge! Your world has been returned to normal, and you have unlocked the Overkill perk!$/, '$1您已完成了破坏挑战！世界恢复了正常，而且您解锁了 超杀 特权！'], //破坏挑战完成信息
    [/^(.*)You have completed the Watch challenge! You have been rewarded with (.*) Helium, and you may repeat the challenge.$/, '$1您已完成了守望挑战！您获取了 $2 氦，现在您又可以继续开始此挑战了。'], //守望挑战完成信息
    [/^(.*)You have completed the Lead challenge! You have been rewarded with (.*) Helium, and you may repeat the challenge.$/, '$1您已完成了领导挑战！您获取了 $2 氦，现在您又可以继续开始此挑战了。'], //领导挑战完成信息
    [/^Travel to a dimension where enemies have 3X attack and Corruption runs rampant, beginning at Z60. The Corruption in this dimension grants helium, but 50% less than normal. Improbabilities and Void Maps will still not gain strength or double reward until Z(\d+). Completing$/, '前往一个敌人攻击力为3倍，且腐化更加泛滥，从区域60就开始的维度。此维度中腐化格子给予氦，但只有正常维度的一半。乌有者及虚空地图直到区域$1之前，既不会因此变强，也不会有双倍奖励。在此挑战激活的前提下通过 '], //腐化挑战
    [/^You have the Corrupted challenge active. Travel to a dimension where enemies have 3X attack and Corruption runs rampant, beginning at Z60. The Corruption in this dimension grants helium, but 50% less than normal. Improbabilities and Void Maps will still not gain strength or double reward until Z(\d+). Completing$/, '您目前激活了腐化挑战。前往一个敌人攻击力为3倍，且腐化更加泛滥，从区域60就开始的维度。此维度中腐化格子给予氦，但只有正常维度的一半。乌有者及虚空地图直到区域$1之前，既不会因此变强，也不会有双倍奖励。在此挑战激活的前提下通过 '], //腐化挑战
    [/^(.*)You have completed the Corrupted challenge! You have been rewarded with (.*) Helium, and you may repeat the challenge.$/, '$1您已完成了腐化挑战！您获取了 $2 氦，现在您又可以继续开始此挑战了。'], //腐化挑战完成信息
    [/^(.*)You have completed the Domination challenge! You have been rewarded with (.*) Helium, and you may repeat the challenge.$/, '$1您已完成了统治挑战！您获取了 $2 氦，现在您又可以继续开始此挑战了。'], //统治挑战完成信息
