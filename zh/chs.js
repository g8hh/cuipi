...
var cnItems = {
	...
	'Zone': '区域',
    'with this challenge active will grant an additional 100% of all helium earned up to that point. This challenge is repeatable!': '，将额外获得100%的氦。此挑战可重复完成！',
	...
	'Crank your portal into overdrive, increasing the clock speed of the Universe. Each level reduces the time between Trimp and Bad Guy attacks by': '把您的传送门调成超速，增加宇宙中的时间流速。把你的传送门搞成超速，需要额外的氦气，但是增加了宇宙的时钟速度。每级可使脆皮与敌人的攻击间隔比上一级减少',
...
var cnRegReplace = new Map([
    ...
    [/^(.*)You have completed the Balance challenge! You have been rewarded with $1 Helium, and you may repeat the challenge.$/, '$1您已完成了平衡挑战！您获取了 $1 氦，现在您又可以继续开始此挑战了。'], //平衡挑战完成信息
