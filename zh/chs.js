...
var cnRegReplace = new Map([
	...
	[/^(.*)Crit Chance, additive/, '$1暴击率，附加'],
	[/^(.*)Crit Damage, additive/, '$1暴击伤害，附加'],
	[/^(.*)Trimp Attack/, '$1脆皮攻击'],
	[/^(.*)Trimp Block/, '$1脆皮防御'],
	[/^(.*)Trimp Health/, '$1脆皮生命'],
	[/^(.*)Void Map Drop Chance/, '$1虚空地图掉落几率'],
	[/^(.*)Metal Drop Rate/, '$1金属掉落加成'],
	[/^(.*)Gem Drop Rate/, '$1宝石掉落加成'],
	[/^(.*)Food Drop Rate/, '$1食物掉落加成'],
	[/^(.*)Wood Drop Rate/, '$1木头掉落加成'],
	[/^(.*)Fragment Drop Rate/, '$1碎片掉落加成'],
	[/^(.*)Farmer Efficiency/, '$1农民效率'],
	[/^(.*)Miner Efficiency/, '$1矿工效率'],
	[/^(.*)Lumberjack Efficiency/, '$1伐木工效率'],
	[/^(.*)Farmer Efficiency/, '$1农民效率'],
	[/^(.*)Dragimp Efficiency/, '$1宝石效率'],
	[/^(.*)Explorer Efficiency/, '$1探险家效率'],
	[/^(.*)Scientist Efficiency/, '$1科学家效率'],
	[/^(.*)Trainer Efficiency/, '$1培训师效率'],
	[/^(.*)Player Efficiency/, '$1玩家效率'],
	[/^(.*)Storage Size/, '$1存储上限'],
	[/^Add \((.+) Nu/, '添加 ($1虚空物质'],
	[/^Replace \((.+) Nu/, '替换 ($1虚空物质'],
