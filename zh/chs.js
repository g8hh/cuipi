...
var cnItems = {
    ...
    'For your past completions of 50 unique Bionic Wonderland Tiers, you have unlocked the following permanent special bonuses: Foremany (Permanently adds 50000 Foreman to your town to aid in construction), AutoJobs, AutoStructure, and Double Build (Stacked items in the Building Queue will be constructed two at a time). As these bonuses were previously Masteries and are now not, new Masteries have been added to replace these!': '对于你过去完成的50个独特的仿生仙境层，你已经解锁了以下永久的特殊奖励:脱颖而出(永久增加50000工头到你的城市，以协助建设)，自动工作, 自动建造，和双重建造(堆叠项目的建设队列将建设两个一次)。由于这些加值以前是高精而现在不是，新的高精被添加来代替!',
