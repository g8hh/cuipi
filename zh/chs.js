...
var cnItems = {
    ...
    'Price': '价格',
    'Spent': '花费',
    "You can sense great power within Fluffy, but he'll need some training. Each level of Capable allows Fluffy to gain 1 level of Experience. Respeccing to remove Capable will temporarily remove any bonuses associated with Fluffy's level and Experience, but all Exp will be saved until you add points back. Each level of Capable is 10x more expensive than the last, and buying the first level will allow Fluffy to take Portals with you.": '你可以在绒绒中感受到巨大的力量，但他需要一些训练。 能力的每个级别都允许绒绒获得1级的经验。 降低能力等级将暂时移除绒绒的等级和经验以及相关的任何奖励，但所有的经验都将被保存，直到重新提升能力等级为止。 能力的每个级别比上一级贵10倍，购买第一级将允许绒绒陪你一起传过传送门。',
    "Fluffy demands more helium! Each level of Cunning will increase the final amount of Experience Fluffy gains from each Zone by 25% (additive).": '绒绒需要更多的氦气！ 每个级别的灵巧将增加 25% 经验(线性)',
    "Fluffy is coming along, but he's coming along slowly. Each point of Curious will speed up Fluffy's progression by adding 60 Exp to the base amount he gains per Zone clear.": '绒绒进步中, 但他进步的有点慢。 每一级的好奇都将加速绒绒的发展。每级增加 60 点每个区域的基础经验。',
