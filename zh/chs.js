...
var cnItems = {
    ...
    'Train one of your Trimps in the ancient art of farming. Each Farmer harvests 0.50 food per second.': '训练一个掌握古老农业技术的脆皮，每个农民每秒获得0.5食物。',
    ...
    'Show a Trimp how to cut one of those weird trees down. Each Lumberjack hauls back 0.50 logs per second.': '教脆皮如何砍下那些奇怪的树木，每个伐木工每秒获得0.5木头',
    'DMG': '攻击力',
    'Soldiers': '士兵',
    'Item Attack': '物品攻击',
    'Min': '最小',
    ...
    'It takes some patience, but you can teach these Trimps to do some research for you. Each Scientist records 0.50 units of pure science each second.': '这需要一些耐心，但是您可以教这些脆皮为您做一些研究。 每个科学家每秒记录0.50个纯科学单位。',
    ...
    'It takes some patience, but you can teach these Trimps to do some research for you. Each Scientist records 0.63 units of pure science each second.': '这需要一些耐心，但是您可以教这些脆皮为您做一些研究。 每位科学家每秒记录0.63单位的纯科学。',
    ...
    'Show a Trimp how to cut one of those weird trees down. Each Lumberjack hauls back 0.78 logs per second.': '向脆皮展示如何砍掉其中一棵怪异的树木。 每个伐木工人每秒钟可拖回0.78根原木。',
    ...
    'Train one of your Trimps in the ancient art of farming. Each Farmer harvests 0.78 food per second.': '在古老的耕作艺术中训练您的脆皮之一。 每个农民每秒收获0.78粮食。',
...
var cnRegReplace = new Map([
    ...
    [/^Welcome back! You were offline for (.+) hours and (.+) minutes.$/, '欢迎回来!你离线$1小时$2分钟。'],
    [/^Welcome back! You were offline for (.+) minutes.$/, '欢迎回来!你离线$1分钟。'],
    [/^(.+) Min (.+) Sec$/, '$1 分 $2 秒'],
    [/^(.+) Level map$/, '$1 级地图'],
    [/^(.+) Secs \/ (.+) Secs$/, '$1 秒 \/ $2 秒'],
    [/^Clear  (.+) total Zones$/, '总共清理 $1 区域'],
    [/^Collect  1 (.+) Gem$/, '收集 $1 宝石'],
    [/^Drops (.+) Gems$/, '掉落 $1 宝石'],
    [/^food:(.+)\($/, '食物: $1 \('],
    [/^metal:(.+)\($/, '金属: $1 \('],
    [/^wood:(.+)\($/, '木头: $1 \('],
