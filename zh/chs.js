...
var cnRegReplace = new Map([
	...
	[/^When this Empowerment is active, each successful attack by your Trimps stacks a debuff on the enemy, causing it to take (.+) of the damage you dealt every attack until it dies. Each attack by your Trimps will further add to the poison effect.$/, '当此赋能激活时，每次脆皮的攻击都可以使敌人增加一层减益，每次攻击时，敌人受到的伤害增加 $1 ，直到其死亡。脆皮每次攻击可以叠加此毒效果。'],
]);
