...
function natureTooltip(event, doing, spending, convertTo){
	...
	if (doing == 'upgrade'){
		...
		tipText = "交易 10 令牌 " + spending + " 然后得到 " + convertRate + " 令牌 " + convertTo + "。";
		tipCost = 10;
	}
...
function getGeneratorHtml(getContainer){
	...
	if (game.permanentGeneratorUpgrades.Supervision.owned)
		html += "<div class='col-xs-4 hasPause' id='generatorProducingColumn' onclick='pauseGenerator()'><div id='generatorProducingContainer'>生产<br/><span id='generatorTrimpsPs'>0</span><br/>住房/轮</div><div id='generatorPauseBtn'>(暂停)</div></div>";
	else
		html += "<div class='col-xs-4' id='generatorProducingColumn'><div id='generatorProducingContainer'>生产<br/><span id='generatorTrimpsPs'>0</span><br/>住房/轮</div></div>";
